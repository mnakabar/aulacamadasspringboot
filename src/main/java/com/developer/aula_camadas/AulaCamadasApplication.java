package com.developer.aula_camadas;
...
public class AulaCamadasApplication  implements CommandLineRunner{
    ...
    public void run(String... args) throws Exception {
        ...
        Category cat2 = new Category(null, "Books");
          ...
          Product p2 = new Product(null, "Dominio Drive Desing", 120.00, cat2);
